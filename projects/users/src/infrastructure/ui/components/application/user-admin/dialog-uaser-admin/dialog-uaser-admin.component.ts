...
@Component({
  selector: 'lib-dialog-uaser-admin',
  ...
  templateUrl: './dialog-uaser-admin.component.html',
  styleUrl: './dialog-uaser-admin.component.scss'
})
export class DialogUaserAdminComponent implements OnInit {
